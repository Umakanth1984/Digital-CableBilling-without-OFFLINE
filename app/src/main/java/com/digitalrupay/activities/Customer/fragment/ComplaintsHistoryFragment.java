...
public class ComplaintsHistoryFragment extends Fragment {
    ...
    public void setComplaints(ArrayList<ComplaintsDataModel> complaintsDataModelArrayList, String message, String text) {
